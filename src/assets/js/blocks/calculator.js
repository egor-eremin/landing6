        ...
        getBuild: function(lang, idBlock) {
            ...
            if (mainBlock) {
                ...
                if (this.defaultTitles[lang]) {
                    ...
                    innerHTMLcontent += '<button class="clc-buttonsCta__btn btn btn-white btn-main" onclick="getCalculate.getData();">' + this.defaultTitles[langBuild].submitBtn + '</button>';
                    innerHTMLcontent += '</div>';
                    innerHTMLcontent += '</div>';

                    innerHTMLcontent += '<div class="clc-results">';
                    // innerHTMLcontent += '<h3 class="clc-calculator__heading">' + this.defaultTitles[langBuild].resultText + '</h3>';
