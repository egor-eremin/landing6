...
function gobuild (obj, data, item, langs) {
    ...
    prevobjcot.forEach( (element) => {
        ...
        htmlContent += '<td><div class="table-btn-wrapper"><a class="btn-sell btn-table" href="' + __CONFIG_GLOBAL.companyData.registratepage + '">' + langs.sell + '</a><a class="btn-buy btn-table" href="' + __CONFIG_GLOBAL.companyData.registratepage + '">' + langs.buy + '</a></div></td>';
        htmlContent += '</tr>';
    })
